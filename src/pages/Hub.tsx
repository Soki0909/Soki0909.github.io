      ...
      <div className="min-h-screen bg-white relative">
        ...
        <header className="border-b border-gray-100 py-12 px-4 relative">
          <div className="max-w-4xl mx-auto">
            ...
            <div
              className="flex items-center gap-4 mb-6 animate-fade-in-up"
            ...
            {/* Statement */}
            <p
              className="text-lg text-gray-600 leading-relaxed max-w-2xl animate-fade-in-up"
            ...
            <a
              href="/profile"
              className="inline-block mt-4 px-4 py-2 bg-gray-900 text-white text-sm font-medium rounded-lg hover:bg-gray-700 transition-colors animate-fade-in-up"
            ...
            {/* Social Links */}
            <div
              className="flex flex-wrap gap-4 mt-6 font-mono text-sm animate-fade-in-up"
        ...
        <main className="max-w-4xl mx-auto px-4 py-12">
          ...
          {/* ===== Writing Area ===== */}
          <AnimatedSection as="section" animation="fade-up" delay={100}>
            <div id="writings" className="mt-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-6 flex items-center gap-2">
                <span className="font-mono text-gray-400">{'# '}</span>
                Writings
              </h2>
